...
[`@aws-sdk/client-connect-contact-lens`](https://www.npmjs.com/package/@aws-sdk/client-connect-contact-lens/v/3.1056.0).
...
- @aws-sdk/client-connect-contact-lens - [https://cloud-sdk-builds.github.io/?sdk=client-connect-contact-lens](https://cloud-sdk-builds.github.io/?sdk=client-connect-contact-lens)
- @aws-sdk/client-connect-contact-lens v3.1056.0 - [https://cloud-sdk-builds.github.io/?sdk=client-connect-contact-lens&version=3.1056.0](https://cloud-sdk-builds.github.io/?sdk=client-connect-contact-lens&version=3.1056.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect-contact-lens@3.1056.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DkrkLPK6DkrhNBNWBgyPRuXb4Lbtt4GEXziU/C/irSPjUuuzyz8dSBBVfLMiP+fH
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect-contact-lens/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-connect-contact-lens": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect-contact-lens@3.1056.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-connect-contact-lens@3.1056.0/index.min.mjs": "sha384-DkrkLPK6DkrhNBNWBgyPRuXb4Lbtt4GEXziU/C/irSPjUuuzyz8dSBBVfLMiP+fH"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-connect-contact-lens";
...
```
https://github.com/cloud-sdk-builds/client-connect-contact-lens/blob/refs/tags/3.1056.0/LICENSE
```
